...
Why I stopped my run after 7 minutes in wet shoes
...
- Composition family: post_run_sitting_route_edge
- Direction: show the runner recovering at the route edge, not posing like a fitness ad
- Camera distance: medium-wide seated frame
- Camera height: phone on ground or low rock/bench height
- Subject scale: runner fills 25-40% of frame
- Face visibility: face can be three-quarter, tired, sweaty, and human
...
- Movement state: seated or crouched recovery, breathing settling
- Text-safe negative space: open route/world area above or beside runner
...
- Hook source family: marathon_rain_minute_6_v1
- Hook source signal: n/a
- Hook source URL: local://inputs/research/road-to-marathon-fit-personal-experience-bank.json#rtmf_week08_rain_nearly_home
...
- Problem type: shoes
- Exact runner language: Rain soaked my shoes and one heel started rubbing after seven minutes.
- Source: local://inputs/research/road-to-marathon-fit-personal-experience-bank.json#rtmf_week08_rain_nearly_home
...
- Viewer emotion: annoyed by stopping, relieved the next day
- Background: shaded forest running route with visible path depth
- Vibe: realistic, calm, premium, useful, not overproduced
- Reddit-derived background: Rain soaked my shoes and one heel started rubbing after seven minutes.
...
- Outfit key: day_01_teal_tee_black_shorts
- Outfit note: day 1 workout outfit, teal top and black shorts
...
- Camera distance: medium-wide seated frame
- Camera height: phone on ground or low rock/bench height
- Lens feel: real post-run phone capture
- Subject scale: runner fills 25-40% of frame
- Face visibility: face can be three-quarter, tired, sweaty, and human
- Movement state: seated or crouched recovery, breathing settling
- Negative-space zone: open route/world area above or beside runner
- Background depth: selected world visible as the place the run happened
...
## Final Prompt To Use
Hard composition requirement before anything else: post-run sitting route-edge frame. show the runner recovering at the route edge, not posing like a fitness ad. Camera distance: medium-wide seated frame. Camera height: phone on ground or low rock/bench height. Subject scale: runner fills 25-40% of frame. Face visibility: face can be three-quarter, tired, sweaty, and human. Text-safe negative space: open route/world area above or beside runner. If this composition conflicts with the 2026-04-26 reference image pose or the avatar variation angle, ignore the reference pose and avatar angle. Do not place the face or torso in the center text-safe zone.
...
Composition: follow this selected hook composition first: post-run sitting route-edge frame. show the runner recovering at the route edge, not posing like a fitness ad. If this conflicts with the avatar variation camera angle, the hook composition wins; the avatar variation supplies wardrobe, weather, lighting, and expression only. Camera distance: medium-wide seated frame. Camera height: phone on ground or low rock/bench height. Lens feel: real post-run phone capture. Subject scale: runner fills 25-40% of frame. Face visibility: face can be three-quarter, tired, sweaty, and human. Movement state: seated or crouched recovery, breathing settling. Negative space for local overlay text: open route/world area above or beside runner. Background depth: selected world visible as the place the run happened. Do not default to the common centered waist-up, front-facing, three-quarter, scenic hero crop unless that is explicitly the selected composition. No face distortion, no watch-checking pose, no hands-on-hips hero pose, no repeated static hero framing, no exaggerated emotion. Show the viewer emotion as annoyed by stopping, relieved the next day through believable body language, face tension when visible, and scene tension, not theatrical acting. Use a natural creator-style crop with enough clean negative space for the hook overlay, but avoid a staged poster layout.
