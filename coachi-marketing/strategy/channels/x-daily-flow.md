...
- repost 1 strong post from a larger account
...
- For every tech/build post, connect it to:
  - a runner problem
  - a user benefit
...
Avoid filling the graph with random big accounts that do not overlap with Coachi.
...
- Daily: 3 posts + distribution actions
- Weekly: 1 deep-dive thread
- Milestones: launch/update/fix posts with direct product framing
